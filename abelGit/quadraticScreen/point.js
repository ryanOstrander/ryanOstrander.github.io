...
function Point(x, y, q){
    ...
    this.pointToPixel = function() {
        ...
        if (this.q == 1) {
            lineNumX = topRightScaleX;
            lineNumY = topRightScaleY;
        }
        if (this.q == 2) {
            lineNumX = topLeftScaleX;
            lineNumY = topLeftScaleY;
        }
        if (this.q == 3) {
            lineNumX = bottomLeftScaleX;
            lineNumY = bottomLeftScaleY;
        }
        if (this.q == 4) {
            lineNumX = bottomRightScaleX;
            lineNumY = bottomRightScaleY;
        }

        var startX;
        var startY;
        var scaleX = (498/2)/lineNumX;
        var scaleY = (372/2)/lineNumY;
